let totaleCasi = document.getElementById('totaleCasi').getContext('2d'),
	...
	screeningDiagnostico = document.getElementById('chartPieScreeningDiagnostico').getContext('2d');
...
let chartPieScreeningDiagnostico = new Chart(screeningDiagnostico, {
	type: 'pie',
	data: {
		labels: [ 'Casi Da Screening', 'Casi da Sospetto Diagnostico' ],
